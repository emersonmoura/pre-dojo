...
describe Parser do
  ...
  let(:started) { '23/04/2013 15:34:22 - New match 11348965 has started' }
  ...
  describe '#parse' do
    ...
    context 'game' do
      ...
      it { expect(@partida.jogador('Roman')).not_to be_nil }
      
      it { expect(@partida.jogador('Roman').assassinatos).to eq '1' }
